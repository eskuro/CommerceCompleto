...
namespace Servicios.Comprobante
{
	public class ComprobanteServicio : IComprobanteServicio
	{
		...
		private void InicializadorDiccionario()
		{
			...
			_diccionario.Add(typeof(CuentaCorrienteComprobanteDto), "Servicios.Comprobante.CuentaCorriente");
		...
		{
			var comprobante = GenericInstance<Comprobante>.InstanciarEntidad(dto,
		   _diccionario);
