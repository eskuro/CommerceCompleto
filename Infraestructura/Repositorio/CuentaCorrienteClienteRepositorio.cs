...
{
	public class CuentaCorrienteClienteRepositorio :Repositorio<CuentaCorrienteCliente> , ICtaCteClienteRepositorio
	{

		public CuentaCorrienteClienteRepositorio(DataContext context)
			:base(context)
		{
        ...
        public override IEnumerable<CuentaCorrienteCliente> Obtener(Expression<Func<CuentaCorrienteCliente, bool>> filtro = null, string propiedadNavegacion = "")
        {
            ...
            var resultadoClient = context.CreateObjectSet<CuentaCorrienteCliente>().OfType<CuentaCorrienteCliente>();
